...
const SymbolsView = () => {
    ...
    const getSymbols = () => {
        const filteredFeeds = [...['BABA', 'ETHx', 'MATICx', 'PYTH', 'stETH', 'stMATIC', 'WOO', 'MATIC Exchange Rate', 'NG', 'QQQ', 'PYPL', 'SSS', 'QWQWQ'], ...new Set(nodaryFeeds.map((feed) => feed.name.split('/')).flat())];
